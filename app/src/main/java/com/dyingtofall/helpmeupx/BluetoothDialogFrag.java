...
public class BluetoothDialogFrag extends DialogFragment
{
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        buttonDesc = (Button) bluetoothView.findViewById(R.id.buttonDiscoverable);
        ...
        detectedAdapter = new ArrayAdapter<String>(getActivity().getApplicationContext(), R.layout.bluetooth_list_item_single_choice);
